...
import { View, Pressable, Text, Modal, TextInput, Keyboard, Alert } from "react-native";
    ...
    <Modal animationType="fade" transparent={true} visible={modalVisible} onRequestClose={onCloseFlag}>
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={driverFlagPopupStyles.centeredView}> 
          <View style={driverFlagPopupStyles.modalView}>
            <View style={driverFlagPopupStyles.modalHeader}>
              <View style={driverFlagPopupStyles.headerTitleContainer}>
                ...
                <FontAwesome name="flag" size={20} color="#E53935" style={driverFlagPopupStyles.flagIcon}/>
          ...
          <Text style={driverFlagPopupStyles.descriptionLabel}>Provide a brief description:</Text>
            <TextInput style={driverFlagPopupStyles.textInput} multiline={true} // allows multiple lines of text
